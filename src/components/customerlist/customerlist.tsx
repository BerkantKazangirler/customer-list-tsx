  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <div className="p-8 mt-5">
        ...
        <div className="flex flex-row mt-5 gap-3 lg:text-lg text-sm">
          ...
          <div className="flex flex-col">
            ...
            {openCustomerArea && (
              <div className="flex flex-col lg:ml-4 relative">
                ...
                <button className="py-5 px-5 bg-neutral-50 rounded-b-xl absolute lg:mt-16 mt-20">
                  Entering manually
                </button>
              </div>
            )}
        ...
        <table className="hidden flex-col bg-neutral-50/90 p-8 mt-10 2xl:flex">
        ...
        <table className="flex flex-col bg-neutral-50/90 w-fit p-8 mt-10 lg:hidden">
          <tr className="flex flex-row text-[#6C757D]">
            <td className="border-r flex flex-row justify-between">
              <span className="w-32 flex pr-2">Full Name</span>
              <div className="flex flex-row gap-3 my-auto">
                <svg
                  width="16"
                  height="16"
            ...
            <td className="border-r flex flex-row justify-between">
              <span className="pr-10 pl-7">Status</span>
              <svg
                width="16"
                height="16"
                viewBox="0 0 16 16"
        ...
        <table className="hidden flex-col bg-neutral-50/90 w-fit p-8 mt-10 lg:flex">
          <tr className="flex flex-row text-[#6C757D]">
            <td className="border-r flex flex-row justify-between">
              <span className="w-32 flex pr-2">Full Name</span>
              <div className="flex flex-row gap-3 my-auto">
